...
- **Name:** NextGenWeb
- **Project ID:** `A9BA324E-4F1D-4ADC-92DB-B8A103D98A3E`
- **Git Root:** `/Users/harshalbhatkar/Documents/Sidekick/nextgenweb`
...
### Browser Control (requires projectId: "A9BA324E-4F1D-4ADC-92DB-B8A103D98A3E")
...
**Open in browser:**
```
new_tab(projectId: "A9BA324E-4F1D-4ADC-92DB-B8A103D98A3E", url: "http://localhost:1729", title: "App")
```

**Verify:**
```
take_screenshot(projectId: "A9BA324E-4F1D-4ADC-92DB-B8A103D98A3E")
```
