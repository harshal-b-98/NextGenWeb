 ...
 *
 * A clean, minimal footer with logo, navigation links, and social icons
 * in a single row layout. Perfect for simple websites.
 */

import { cn, container } from '@/lib/design-system';
import type { FooterSimpleProps, SocialLink } from './types';
